...
public class Post implements Post_interface  {
    ...
    //  α(c) = {c.id, c.author, System.currentTimeMillis(), [c.likes.get(index)] }
    ...
    public void removeLikes(String user) throws NullPointerException{
        ...
        //se user è nella lista dei mi piace si rimuove, in questo caso non si utilizza un eccezione in quanto l'azione non porta ad errori
        if(index!=-1){
