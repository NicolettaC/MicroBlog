...
public class TestSet {
    public static void main(String[] args) {
        ...
        System.out.println("/////Questo test prova alcuni casi particolari\n");
        Test2(sc);
        System.out.println("\n ************************ FINE TEST2 ************************ \n");
    ...
    public static void Test1(SocialNetwork sc) {
        ...
        try {
            UserRetePost = sc.getMentionedUsers(sc.GetallPosts());
        } catch (Exception e) {
            System.out.println(e);
        }
        ...
        try {
            followers = sc.guessFollowers(sc.GetallPosts());
        } catch (Exception e) {
            System.out.println(e);
        }
        ...
        System.out.println("   Gli utenti con con followers > 4 && followers > following sono  :" + Influencers);
    ...
    public static void Test2(SocialNetwork sc) {
        ...
        try {
            PostUtente1 = sc.writtenBy(AllPosts, "utente1");
        } catch (Exception e) {
            System.out.println(e);
        }

        System.out.println(PostUtente1);
        ...
        System.out.println("\n");
        System.out.println("-Gli utenti che hanno scritto almeno un post nella rete sono " + UserRetePost.size() + ":");

        System.out.println(UserRetePost);

        System.out.println("\n");
        System.out.println("-Provo metodo Influencers con null: ");

        try {
            Influencers = sc.influencers(null);
        } catch (Exception e) {
            System.out.println(e);
        }
